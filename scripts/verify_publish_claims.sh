...
GO20B=${HOME}/models/gpt-oss-20b-GGUF/gpt-oss-20b-mxfp4.gguf
GO120B=${HOME}/models/lmstudio-community/gpt-oss-120b-GGUF/gpt-oss-120b-MXFP4-00001-of-00002.gguf
...
echo "         ${HOME}/llama.cpp-vulkan/llama-b8902/llama-bench"
