...
int main() {
    ...
    // DeepSeek-V4.1-Flash element types (2026-09-12): mapped now, kCount before.
    assert(ie::SafetensorsReader::dtype_from_string("F8_E4M3") == ie::DType::kFP8_E4M3);
    assert(ie::SafetensorsReader::dtype_from_string("F8_E8M0") == ie::DType::kE8M0);
    assert(ie::SafetensorsReader::dtype_from_string("F8_E5M2") == ie::DType::kCount);
