...
private:
    ...
    // Coalesced-load Q6_K lm_head decode (IE_Q6K_SOA_V2, default ON): SoA-Q6
    // streams (output / tied token_embd) for gemv_q6_soa_q8_v2 — mirrors the
    // dense/crown lm_head win. Null → float gemv_q fallback.
    ...
    void*  ws_lm_q8_ = nullptr;    // block_q8_1x [H/32] lm_head decode activation (v2)
