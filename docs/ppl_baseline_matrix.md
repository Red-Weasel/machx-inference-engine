...
| | path |
|---|---|
| Original GGUF | `~/.seal/models/Qwen3.6-35B-A3B-Q4_K_M.gguf` |
| lmhead-q4k GGUF | `~/.seal/models/Qwen3.6-35B-A3B-Q4_K_M-lmhead-q4k.gguf` |
| llama.cpp build | `~/llama.cpp-vulkan/llama-b8902/llama-perplexity` (Vulkan) |
...
~/llama.cpp-vulkan/llama-b8902/llama-perplexity \
  -m ~/.seal/models/Qwen3.6-35B-A3B-Q4_K_M.gguf \
