...
case "$M" in
  crown)  G=${HOME}/.seal/models/Qwen3.6-35B-A3B-Q4_K_M.gguf; DEV=0; VK=0; SPECF="";;
  27b)    G=${HOME}/models/bartowski/Qwen3.6-27B-GGUF/Qwen_Qwen3.6-27B-Q4_K_M.gguf; DEV=0; VK=0; SPECF="--spec --spec-k 2";;
  coder)  G=${HOME}/models/Qwen3-Coder-30B-GGUF/Qwen3-Coder-30B-A3B-Instruct-Q4_K_M.gguf; DEV=0; VK=0; SPECF="";;
  gemma31)G=${HOME}/models/google/gemma-4-31B-it-qat-q4_0-gguf/gemma-4-31B_q4_0-it.gguf; H=${HOME}/models/google/gemma-4-31B-it-qat-q4_0-gguf/mtp-gemma-4-31B-it-Q8_0.gguf; DEV=0; VK=1; SPECF="--spec --spec-k 4 --spec-head $H";;
  gemma26)G=${HOME}/models/google/gemma-4-26B-A4B-it-qat-q4_0-gguf/gemma-4-26B_q4_0-it.gguf; H=${HOME}/models/google/gemma-4-26B-A4B-it-qat-q4_0-gguf/mtp-gemma-4-26B-A4B-it-Q8_0.gguf; DEV=0; VK=1; SPECF="--spec --spec-k 4 --spec-head $H"; export IE_GEMMA4_FUSED_MOE=1 IE_GEMMA4_MOE_SOA=1;;
  next80) G=${HOME}/models/Momix-44/Qwen3-Coder-Next-Opus-4.6-Reasoning-Distilled-Dreamified/Qwen3-Coder-Next-Opus-4.6-Reasoning-Distilled-Dreamified-Q4_K_M.gguf; DEV="0,1"; VK=0; SPECF="--gpus 2";;
