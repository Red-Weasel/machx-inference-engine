...
CROWN=${HOME}/.seal/models/Qwen3.6-35B-A3B-Q4_K_M.gguf
D27=${HOME}/models/bartowski/Qwen3.6-27B-GGUF/Qwen_Qwen3.6-27B-Q4_K_M.gguf
CODER=${HOME}/models/Qwen3-Coder-30B-GGUF/Qwen3-Coder-30B-A3B-Instruct-Q4_K_M.gguf
G31=${HOME}/models/google/gemma-4-31B-it-qat-q4_0-gguf/gemma-4-31B_q4_0-it.gguf
G31H=${HOME}/models/google/gemma-4-31B-it-qat-q4_0-gguf/mtp-gemma-4-31B-it-Q8_0.gguf
G26=${HOME}/models/google/gemma-4-26B-A4B-it-qat-q4_0-gguf/gemma-4-26B_q4_0-it.gguf
G26H=${HOME}/models/google/gemma-4-26B-A4B-it-qat-q4_0-gguf/mtp-gemma-4-26B-A4B-it-Q8_0.gguf
NEXT80=${HOME}/models/Momix-44/Qwen3-Coder-Next-Opus-4.6-Reasoning-Distilled-Dreamified/Qwen3-Coder-Next-Opus-4.6-Reasoning-Distilled-Dreamified-Q4_K_M.gguf
